...
<li class="current"><a href="engineering.php" title="工程硕士"><span>工程硕士</span></a></li>
...
<div class="guid">
	<ul>
      ...
      <li>&gt;</li>
	  <li><a href="engineering.php">工程硕士</a></li>
 </ul>
</div>
<div class="menu1">
<div class="add">
...
{
if($fname!=null){
$sql="insert into manage_degree_first(degree,dfname) values('"."工程硕士"."','".$fname."')";
$insert=mysql_query($sql,$conn);
if($insert){
echo "<script>alert('成功添加');window.location.href='engineering.php';</script>";
}else{
...
//echo '<script>alert("成功")</script>';
mysql_query("set names utf8");
$arr=mysql_query("select dfname from manage_degree_first where degree='工程硕士'",$conn);
...
if($delete){
echo "<script>alert('成功删除');window.location.href='engineering.php';</script>";
}
}
?>
</td>
